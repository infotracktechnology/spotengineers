            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <form method="post" id="myForm" action="customer-update.php ?id=<?= $id; ?>" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="col-md-3 form-group">
                          ...
                          <select name="type" id="type" class="form-control form-control-sm" value ="<?= $customer[0]->type; ?>" required>
